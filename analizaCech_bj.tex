...
\hypersetup{unicode=true,
            pdftitle={Analiza datasetu - cechy},
            pdfauthor={Joanna Gajewska \& Olaf Werner \& Bogdan Jastrzębski},
            pdfborder={0 0 0},
            breaklinks=true}
...
\section{1. Wstępna analiza zbioru
danych}\label{wstepna-analiza-zbioru-danych}
...
rozmaite flagi wykorzystane przez autorów, do oznaczania braków,
nieścisłości etc.

\subsection{1.1 Flagi}\label{flagi}
