...
Początkowo wyniki jakie otrzymywaliśmy tranując klasyfikator random forest na zbiorze pierwotnym, bez żadych modyffikacji to auc=0,77 . Po tuningu otrzymaliśmy wynik auc=0,798 . Można uznać, że jest to zdecydowanie zadowalający rezultat biorąc pod uwagę fakt że zwycięscy konkursu otrzymali podobny wynik. 
